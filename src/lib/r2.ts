...
export const R2_BUCKET_NAME = process.env.R2_BUCKET_NAME || "magnuskleid-products";
export const R2_PUBLIC_URL = process.env.R2_PUBLIC_URL || "https://cdn.maagnuskleid.com";